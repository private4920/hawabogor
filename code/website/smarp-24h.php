...
$sql = "SELECT timestamp, pm2524h, pm1024h, pm124h, aqi
        FROM LocationA
...
if ($result->num_rows > 0) {
    ...
    $nowcastpm25 = $row["pm2524h"];
    $nowcastpm10 = $row["pm1024h"];
    $nowcastpm1 = $row["pm124h"];
    $nowcastaqi = $row["aqi"];
...
<head>
  <meta charset="utf-8">
    <title>Rata-Rata 24 Jam - Kec. Bogor Tengah - HawaBogor - Air Quality Index</title>
...
<body class="govuk-template__body app-body-class" data-test="My value" data-other="report:details">
  ...
  <div class="govuk-width-container app-width-container">
    ...
    <main class="govuk-main-wrapper app-main-class" id="main-content" role="main">
      ...
      <h1 class="govuk-heading-xl">Indeks Kualitas Udara (Rata-Rata 24 Jam)</h1>
...
<div class="titlebox" style="color: $pm25textcolor;">
PM 2.5
</div>
<div class="parametervalue" style="color: $pm25textcolor;">
$nowcastpm25 <span class="parameterunit">µg/m³</span>
</div>
</div>
<div class="insidebox" style="background-color:	$pm10color;">
<div class="titlebox" style="color: $pm10textcolor;">
PM 10
</div>
<div class="parametervalue" style="color: $pm10textcolor;">
